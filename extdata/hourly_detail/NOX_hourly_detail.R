...
output$NOx_1$data <- list_stations_with_parameter(parameter_name, data_type = "hourly")

output$NOx_2$result_message <- print(paste0(parameter_name, "_2 : %90 veri alınan istasyon listesi" ))
output$NOx_2$data <- list_stations_with_parameter(parameter_name, data_type = "hourly", threshold = 90)
