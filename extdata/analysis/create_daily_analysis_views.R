create_daily_analysis_views <- function(start_year, end_year, schema_name, parameters) {
  ...
  # NOX ----------------------------
  if("NOX" %in% parameters) {
    message("Calculating NOX...")
