...
output$PM10_1$data <- list_stations_with_parameter(parameter_name, "daily", until_year = 2024)

output$PM10_2$result_message <- print(paste0(parameter_name, "_2 : Veri alınan istasyon sayısı (yıllara göre)" ))
output$PM10_2$data <- list_stations_with_parameter_count(parameter_name, "daily", until_year = 2024)

output$PM10_3.1$result_message <- print(paste0(parameter_name, "_3.1 : %90 veri alınan istasyon listesi" ))
output$PM10_3.1$data <- list_stations_with_parameter(parameter_name, "daily", threshold = 90, until_year = 2024)

output$PM10_3.2$result_message <- print(paste0(parameter_name, "_3.2 : %75 veri alınan istasyon listesi" ))
output$PM10_3.2$data <- list_stations_with_parameter(parameter_name, "daily", threshold = 75, until_year = 2024)

output$PM10_4$result_message <- print(paste0(parameter_name, "_4 : %90 Veri alınan istasyon sayısı" ))
output$PM10_4$data <- count_stations_with_parameter_threshold(parameter_name, threshold = 90, data_type = "daily", until_year = 2024)

output$PM10_5$result_message <- print(paste0(parameter_name, "_5 : için istasyon ortalamaları"))
output$PM10_5$data <- station_average(parameter_name, "daily", threshold = 90, until_year = 2024)
...
output$PM10_6$data <- calculate_above_exceedance_all_stations(parameter_name, "daily", pollutant_threshold = 40, until_year = 2024)
...
output$PM10_7$data <- calculate_below_exceedance_all_stations(parameter_name, "daily", pollutant_threshold = 40, until_year = 2024)
...
output$PM10_8$data <- calculate_above_exceedance_all_stations(parameter_name, "daily", pollutant_threshold = 15, until_year = 2024)
...
output$PM10_9$data <- calculate_below_exceedance_all_stations(parameter_name, "daily", pollutant_threshold = 15, until_year = 2024)
...
output$PM10_10$data <- calculate_above_exceedance_all_stations(parameter_name, "daily", pollutant_threshold = 50, until_year = 2024)
...
output$PM10_11$data <- calculate_above_exceedance_all_stations(parameter_name, "daily", pollutant_threshold = 45, until_year = 2024)
...
output$PM10_12$data <- calculate_below_exceedance_all_stations(parameter_name, "daily", pollutant_threshold = 45, until_year = 2024)
...
output$PM10_13$data <- calculate_above_exceedance_all_stations(parameter_name, "daily", pollutant_threshold = 45, until_year = 2024)

output$PM10_14$result_message <- print(paste0(parameter_name, "_14: İl PM10 yıllık ortalaması" ))
output$PM10_14$data <- calculate_overall_average_by_city_threshold(parameter_name, "daily", until_year = 2024)
